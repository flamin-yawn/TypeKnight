...
public class WordGenerator : MonoBehaviour
{
    private static string[] wordList = {"sidewalk", "robin", "three", "protect", "periodic",
                                    ...
                                    "ablaze", "thoughtless", "love", "verdict", "giant", "shame", "cover",
                                    "similar", "explicit", "close", "ally", "letter", "nap", "role", "color",
                                    "blind", "folklore", "chaos", "retailer", "computer", "virus", "kit", "dish",
                                    "approach", "qualify", "arch", "grateful", "conversation", "dinner", "winter",
                                    "cause", "rocket", "material", "kneel", "cinema"};
